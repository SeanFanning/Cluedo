...
public class Hypothesis {
    ...
    public void form_hypothesis(int player_num) {
        ...
        players[player_num].addNote("You are in the " + room);
        ...
        players[player_num-1].addNote("You accused " + character + ".");
        do {
        ...
        players[player_num-1].addNote("You picked the " + weapon + " weapon.");
